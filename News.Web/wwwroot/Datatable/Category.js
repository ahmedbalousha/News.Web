        ...
        var datatable = $('#kt_datatable').KTDatatable({
            ...
            },
            {
                ...
                template: function (data) {
                    return '\<a  href ="/admin/Category/Update/' + data.id + '" class="PopUp btn btn-sm btn-clean btn-icon mr-2" title="تعديل  بيانات ' + data.name + ' ">\
                        ...
                        <a href ="/admin/Category/Delete/' + data.id + '" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Delete">\
